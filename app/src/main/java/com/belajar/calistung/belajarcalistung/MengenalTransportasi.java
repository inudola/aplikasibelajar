...
public class MengenalTransportasi extends Activity {
    private int a = 0;
    private int b = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mengenal_transportasi);
        ...
        imview.setBackgroundResource(lzm.gambarsaya4[a]);
        ibsan.setBackgroundResource(lzm.gambartransportasi[a]);
        ...
        menu.setOnClickListener(new ImageButton.OnClickListener() {
            public void onClick(View v) {
                MengenalTransportasi.this.openOptionsMenu();
    ...
    public void halighan() {
        ...
        bk = rndGenerator.nextInt(13);
        imview.setBackgroundResource(lzm.gambarsaya4[bk]);
        ibsan.setBackgroundResource(lzm.gambartransportasi[bk]);
        player(bk);
        a = bk;
    }
    ...
    public void player(int i) {
        if (sound == true) {
            ...
            mMediaPlayer = MediaPlayer.create(MengenalTransportasi.this, lzm.musiksaya4[i]);
            mMediaPlayer.start();
        } else if (sound == false) {
            if (mMediaPlayer != null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == 1) {
            ...
            tallash.setClass(MengenalTransportasi.this, TebakAngka.class);
            MengenalTransportasi.this.startActivity(tallash);
